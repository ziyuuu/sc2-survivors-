...
try{
 ...
 report.loaded=await page.evaluate(()=>window.__SC2_REPORT__());assert.equal(report.loaded.originalAnimationModels,8);assert.equal(report.loaded.originalDeathModels,8);assert.equal(report.loaded.effectTextures,30);
