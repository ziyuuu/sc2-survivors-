...
const out='reports/local/qa-v14-file-fixtures';await fs.mkdir(out,{recursive:true});
const meta={at:new Date().toISOString(),debugOnly:true,baselineRevision:sha,currentRevision:execFileSync('git',['rev-parse','HEAD'],{encoding:'utf8'}).trim(),files:[]};
