...
- Between stages offer three distinct cards; at most one paid selection or skip, random discounts and paid rerolls; do not filter offers by affordability or guarantee buildings. Reinforcements are also paid and rescued. Card affordability/payment must be atomic while production is paused. Do not put a manual shop back in battle.
