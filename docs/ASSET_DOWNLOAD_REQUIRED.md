...
1.0目标仅玩家爆虫自爆后留场5秒，其原死亡动画只用于敌方自爆或真实被击杀；当前实现仍用死亡动画。三族空中英雄中净化者航母已有本地GLB；大和战列巡洋舰与HotS利维坦的真实战斗模型仅有锁定SC数据路径、尚未导入本地可玩GLB，三者挂点/画面仍待人工验收，见[MVP战斗稿第9节](MVP10_COMBAT_ASSETS.md#9-三族空中英雄英雄强化与友方爆虫r6)。
