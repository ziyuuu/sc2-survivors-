...
当前 V17 保留五兵种、合批增援、15 款紫色精英、三位英雄与通关后的无尽战场。普通波次／守军下调约 10%，简单仍为原预算的 50%。本轮修正劫掠者展开，优化地形、遮挡检查、渲染和重新部署，并继续无损缩小离线包。**12 关共 30 分钟**、原地图、实体碰撞、手动架炮、点选集火和手柄保留。详见 [当前设计](docs/DESIGN.md)、[验收记录](docs/QA.md)。[困难／地狱与局外天赋设计](docs/DIFFICULTY_AND_TALENTS_PROPOSAL.md) 尚未实装。
