...
export const STAGES:StageConfig[]=names.map((name,i)=>({id:i+1,name,durationSeconds:60*(1+Math.floor(i/3)),ambient:ambient[i],guards:guards[i],entranceSpacing:i<3?.3:i<5?.8:.35,waves:[6,6,7,10,12,12,14,14,16,24,27,30][i],lingHp:[18,24,30][i]??35,speed:[1,1,1.1,1.1,1.12,1.12,1.15,1.15,1.18,1.18,1.2,1.2][i],width:[28,36,44,52,60,68,76,84,92,100,104,112][i],podHp:[600,900,1200,1500,1800,2100,2400,2400,2400,2400,2400,2400][i],reward:rewards[i],drones:i<2?4:i<3?2:i<9?3:4,eggs:i<2?3:2}));
