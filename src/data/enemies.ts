...
export type EnemyTier='elite'|'boss'|'lord';
...
export const ENEMY_NAMES={elite:{zergling:'猎杀跳虫',roach:'重甲蟑螂',hydralisk:'尖刺刺蛇',ravager:'腐蚀破坏者'},boss:{zergling:'巨型跳虫',roach:'巨型蟑螂',hydralisk:'巨型刺蛇',ravager:'巨型破坏者'},lord:{zergling:'巨型跳虫',roach:'巨型蟑螂',hydralisk:'巨型刺蛇',ravager:'巨型破坏者'}};
