...
export class GamepadInput {
 ...
 private suspend(){if(!this.active)return;this.world.input={x:0,z:0};this.armed.clear();this.states.clear();if(this.world.phase==='battle'){this.world.paused=true;this.world.changed();}}
