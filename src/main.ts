...
async function boot(){const view=new BattleRenderer(canvas,world),hud=new HUD(world,view),audio=new AudioEffects();
 ...
 window.__SC2_REPORT__=()=>({...view.report(),phase:world.phase,stage:world.stage,time:world.time,stats:{...world.stats},assetsReady:hud.ready,simulationBacklogSeconds:driver.accumulator});
